export enum FetchNews {
  Pending = '[Pending] Fetch news',
  Success = '[Success] Success on fetching news',
  Error = '[Error] Error occurred when fetching news',
...
export enum FetchSources {
  ...
  Error = '[Error] Error occurred when fetching sources',
  Clear = '[Clear] Clear sources',
}
